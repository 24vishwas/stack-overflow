...
function Tags() {
  ...
  const tagsList = [{
    ...
    id: 3,
    tagName: "c#",
    tagDesc:"C# (pronounced 'see sharp) 'is a high level, statically typed, multiparadigm programming language developed by Microsoft"
    ...
    id:9,
    tagName:"node.js",
    tagDesc:"Node.is is an event-based, non blocking, asynchronous I/O runtime that uses Google's V8 JavaScript engine and libuv library."
  }]
