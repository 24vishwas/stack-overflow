                                ...
                                <section className='question-details-container'>
                                    ...
                                    <div className='question-details-container-2'>
                                        <div className="question-votes">
                                            <img src={upvote} alt='upvote' width={48} onClick={handleUpvote} className='votes-icon'/>
                                            <p>{question.upVote.length - question.downVote.length}</p>
                                            <img src={downvote} alt='downvote' width={48} onClick={handleDownvote} className='votes-icon'/>
                                        </div>
                                        <div style={{width:"100%"}}>
